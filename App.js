...
import { FilseScreen } from './screens/FilseScreen/FilseScreen'
...
function MyCarStack() {
	return (
		<Stack.Navigator headerMode={"none"}>
			...
			<Stack.Screen initialParams={{ showLeft: false }} name="MyMessageOnCar" component={MyMessage} />
			<Stack.Screen name="FilseScreen" component={FilseScreen} />
		</Stack.Navigator>
	);
}
